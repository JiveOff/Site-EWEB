<template>
  <div>
    ...
    <div class="row" style="text-align: center; margin-bottom: 5px; width: 100%">
      <div class="col-6">
        <b style="font-weight: 501">...</b><br /><h4 style="font-size: 12px;">Abonnés</h4>
      </div>
      <div class="col-6">
        <b style="font-weight: 501">...</b><br /><h4 style="font-size: 12px;">Abonnements</h4>
      </div>
    </div>
  </div>
</template>
