  ...
  <div class="posty" style="margin-bottom: 20px">
    <div class="post-bar no-margin">
      ...
      <div class="job_descp">
        ...
        <vue-masonry-wall :items="article.post.images" :options="{columns: 2, width: 300, padding: {2: 8, default: 12}}">
          ...
          <ul>
            <li v-for="comment in article.comments" :key="comment" style="border-bottom: 1px solid rgb(229, 229, 229); margin-bottom: 17px;">
              <div class="comment-list" style="padding-bottom: 20px;">
                <div class="bg-img">
                  <img :src="$store.state.users[comment.user].profile" alt="" width="40px">
                </div>
                <div class="comment">
              ...
              <ul>
                <li v-for="sub in comment.sub" :key="sub">
                  <div class="comment-list">
                    <div class="bg-img">
                      <img :src="$store.state.users[sub.user].profile" alt="" width="40px">
                    </div>
                    <div class="comment">
